...
.stApp {
    background:
      radial-gradient(circle at 18% 18%, rgba(30, 99, 255, 0.18), transparent 28%),
      radial-gradient(circle at 82% 12%, rgba(255, 124, 46, 0.12), transparent 26%),
      radial-gradient(circle at 50% 90%, rgba(14, 165, 233, 0.10), transparent 28%),
      linear-gradient(180deg, #07111f 0%, #0b1730 48%, #050b14 100%);
}
.block-container {
    padding-top: 1.4rem;
    padding-bottom: 2rem;
...
.login-card {
    background: linear-gradient(160deg, rgba(15, 23, 42, 0.96), rgba(17, 34, 64, 0.94));
    border: 1px solid rgba(255,255,255,0.13);
    border-radius: 24px;
    padding: 26px;
...
div[data-testid="stFormSubmitButton"] button {
    background: linear-gradient(180deg, #2f6bff, #174bd6) !important;
...
/* General readable text in dark app */
